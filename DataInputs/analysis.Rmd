...
load("C:/Users/keyserf/Documents/temp_data/OSAC_tidy_logs.RData")
...
png(filename=paste0("cfts_26.png"), width=8, height=6, units = "in", res=420)
...
png(filename=paste0("cfts_25.png"), width=8, height=6, units = "in", res=420)
