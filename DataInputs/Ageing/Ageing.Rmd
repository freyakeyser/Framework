...
png(paste0(plotsGo, "/", bank, "/fit_vb.png"),width=2100, height=2100, units = "px", res=420)
ggplot() + 
  geom_point(data=tpd_long, aes(AGE, HEIGHT), size=1)+
...
png(paste0(plotsGo, "/", bank, "/resid_vb.png"),width=2100, height=2100, units = "px", res=420)
ggplot() + 
...
png(paste0(plotsGo, bank, "/growth_vb.png"), width=3150, height=1575, units = "px", res=420)
age + sh + plot_layout(guides="collect")  
dev.off()
