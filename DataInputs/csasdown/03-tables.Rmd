...
#   )
# )
csas_table(tab_sts, caption ="Long term medians (up to and including 2022 data, except for SFA 26C unlined gear) for survey indices.") %>% kableExtra::row_spec(0,bold=TRUE)
