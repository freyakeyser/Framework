...
names(ps_tab) <- c("SFA", "Management unit", "Number of samples", "Number of years with PS data", "Most recent year with PS data", "Number of months with PS data, all years combined (to a maximum of 12)", "Long term median MW (g)", "Standard deviation MW (g)", "Minimum MW (g)", "Maximum MW (g)")

ps_tab$`Bank`[ps_tab$`Management unit`=="Sab"] <- "Sable Bank"
ps_tab$`Bank`[ps_tab$`Management unit`=="Mid"] <- "Middle Bank"
ps_tab$`Bank`[ps_tab$`Management unit`=="Ban"] <- "Banquereau Bank"
ps_tab$`Bank`[ps_tab$`Management unit`=="BBn"] <- "Browns Bank North"
ps_tab$`Bank`[ps_tab$`Management unit`=="BBs"] <- "Browns Bank South"
ps_tab$`Bank`[ps_tab$`Management unit`=="Ger"] <- "German Bank"
ps_tab$`Bank`[ps_tab$`Management unit`=="GBb"] <- "Georges Bank 'b'"

ps_tab$`Label`[ps_tab$`Management unit`=="Sab"] <- "25A-Sab"
ps_tab$`Label`[ps_tab$`Management unit`=="Mid"] <- "25A-Mid"
ps_tab$`Label`[ps_tab$`Management unit`=="Ban"] <- "25B"
ps_tab$`Label`[ps_tab$`Management unit`=="BBn"] <- "26A"
ps_tab$`Label`[ps_tab$`Management unit`=="BBs"] <- "26B"
ps_tab$`Label`[ps_tab$`Management unit`=="Ger"] <- "26C"
ps_tab$`Label`[ps_tab$`Management unit`=="GBb"] <- "27B"

ps_tab$`Management unit`[ps_tab$`Management unit`=="Sab"] <- "25A"
ps_tab$`Management unit`[ps_tab$`Management unit`=="Mid"] <- "25A"
ps_tab$`Management unit`[ps_tab$`Management unit`=="Ban"] <- "25B"
ps_tab$`Management unit`[ps_tab$`Management unit`=="BBn"] <- "26A"
ps_tab$`Management unit`[ps_tab$`Management unit`=="BBs"] <- "26B"
ps_tab$`Management unit`[ps_tab$`Management unit`=="Ger"] <- "26C"
ps_tab$`Management unit`[ps_tab$`Management unit`=="GBb"] <- "27B"

ps_tab <- dplyr::select(ps_tab, SFA, `Management unit`, Bank, Label, 3:10)
...
csas_table(ps.prop, caption ="The proportion of scallops under 90 mm in shell height landed by the commercial fishery from stocks in SFAs 25, 26, and 27B. 'Year-round' estimates were derived using all available port sampling data, while 'Apr--Aug' estimates were derived from port sampling data collected from April to August only.") %>% kableExtra::row_spec(0,bold=TRUE)
