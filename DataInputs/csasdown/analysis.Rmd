...
ggplot() + 
  geom_line(data=growth[!growth$version %in% c("vonB only"),], aes(year, value, colour=version)) +
  geom_point(data=growth[!growth$version %in% c("vonB only"),], aes(year, value, colour=version, shape=version)) +
  theme_bw() + 
