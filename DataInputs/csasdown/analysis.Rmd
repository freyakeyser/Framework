...
growth <- data.frame(bank="BBn", year=mod.dat$BBn$year, g2=mod.dat$BBn$g2, gR2 = mod.dat$BBn$gR2, version="old")
...
growth$version <- factor(growth$version, levels=c("new", "vonB only", "old"))

if(french==T){
  growth$version <- gsub(x=growth$version, pattern="old", replacement="ancien")
