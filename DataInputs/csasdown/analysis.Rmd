...
growth <- rbind(growth, 
                data.frame(bank="BBn", year=mod.dat$BBn$year, g2=mod.dat$BBn$g2, gR2 = mod.dat$BBn$gR2, version="new")
                )
...
growth$version <- factor(growth$version, levels=c("new", "vonB only", "original"))
