...
for (i in 1:n.banks){
  ...
  print(ggplot() + geom_sf(data=boundary, fill=NA) + 
...
bbn.20 <- read.csv("C:/Users/keyserf/Documents/temp_data/BBn_input_data_for_freya.csv")
bbn.20 <- bbn.20[bbn.20$year %in% years,]

sab.10 <- read.csv("C:/Users/keyserf/Documents/temp_data/Sab_mod_input_for_freya.csv")
