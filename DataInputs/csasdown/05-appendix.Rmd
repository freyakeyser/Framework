...
img <- magick::image_read("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/BBn/shf_selectivity_cumulative.png") # read the image using the magic library
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/Mid/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/Ban/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/BBs/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/Ger/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/GBb/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/Sab/shf_selectivity_cumulative", fr, ".png"))
```
...
knitr::include_graphics(paste0("Y:/Offshore/Assessment/Framework/SFA_25_26_2024/DataInputs/Port_sampling/mod_wbit/BBn/shf_selectivity_cumulative", fr, ".png"))
```
