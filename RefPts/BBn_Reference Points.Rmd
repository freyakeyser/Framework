...
r.strat <- data.frame(type = "bp",strat = 'dist', bp = 1.15e4,mn.mx = 0.1*signif(min(prod.dat$RPS3,na.rm=T),digits=2), sd.mx = 0.2,rec.age=3,
...
m.strat <- data.frame(type = "bp",strat = 'dist', bp = 1.15e4,mn.mx = 2*signif(max(prod.dat$m,na.rm=T),digits=2), sd.mx = 0.1, ar1=signif(p.m.pacf$data$Freq[1],digits=2),ar2=0) #
