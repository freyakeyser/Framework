...
seam.select <- "1994_2022_vary_m_m0_2_qR_0.5_12_knots"
...
plot.url <- paste0(rp.loc,"Figures/Sab/R_75_FR_90/",seam.select,"/")
...
Res <- proj.mod(n_sim=500,n_y = 100,model=mod,plot_url = plot_url, run = 'no_model_error', res_url = res_url,save.results = T, exp.scenario=seq(0,0.14,0.01) , mod.run = seam.select,
