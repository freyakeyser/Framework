...
bm.last.3.26a <- round(ma.three.mean.26a[length(ma.three.mean.26a)],digits=2)
...
# Current 3 year geometric mean biomass
bm.last.3.26c <- round(ma.three.mean.26c[length(ma.three.mean.26c)],digits=2)
...
# Current 3 year geometric mean biomass
bm.last.3.27b <- round(ma.three.mean.27b[length(ma.three.mean.27b)],digits=2)
