...
p.g.acf <- ggAcf(prod.dat$g) + ggtitle("") + ylab("ACF Growth (FR)")# No autocorrelation in growth of FR
p.gR.acf <- ggAcf(prod.dat$gR) + ggtitle("") + ylab("ACF Growth (Recruits)")# No autocorrelation in growth of Rec
