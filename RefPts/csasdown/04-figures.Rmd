...
\newpage
```{r kobe-bmi-fig, echo=F, fig.cap="Phase plot for each of the areas. The relative fishing mortality is on the y-axis and survey biomass index is on the x-axis. The numbers on the plot represent the year."}
