...
\newpage
```{r rp-bmi-fit, echo=F, fig.cap="Survey biomass index time series (black line) for each of the areas. The geometric mean for the most recent three-years of data is represented by the thick yellow line. The LRPs are represented by the red dotted line ($B_{MSY(30)}$), the dashed red line ($B_{MSY(40)}$), and the solid red line ($B_{0(20)}$). The USRs are represented by the dashed blue line ($B_{MSY(80)}$) and the solid blue line  ($B_{0(40)}$)."}
...
\newpage
```{r sab-mod-rps-fig, echo=F, fig.cap="The historically modelled fully-recruited biomass time series (black line) relative to a suite of potential reference points in SFA 25A developed using the MSY simulations. The LRPs are represented by the red dotted line ($B_{MSY(30)}$), the dashed red line ($B_{MSY(40)}$), and the solid red line ($B_{0(20)}$). The USRs are represented by the dashed blue line ($B_{MSY(80)}$) and the solid blue line  ($B_{0(40)}$). The solid yellow line is the estimated Biomass at MSY."}
...
\newpage
```{r bbn-mod-rps-fig, echo=F, fig.cap="The historically modelled fully-recruited biomass time series (black line) relative to a suite of potential reference points in SFA 26A developed using the MSY simulations. The LRPs are represented by the red dotted line ($B_{MSY(30)}$), the dashed red line ($B_{MSY(40)}$), and the solid red line ($B_{0(20)}$). The USRs are represented by the dashed blue line ($B_{MSY(80)}$) and the solid blue line  ($B_{0(40)}$). The solid yellow line is the estimated biomass at MSY."}
...
\newpage
```{r bbn-mod-reals-rps-fig, echo=F, fig.cap="MSY Simulation time series of fully-recruited biomass projections in SFA 26A when harvesting occurs at $RR_{tar}$. A LRP ($B_{0(20)}$; solid red line) and USR ($B_{0(40)}$; solid blue line) are shown for reference.  Each grey line represents one of the 5000 realizations, and the thick black line is the median."}
