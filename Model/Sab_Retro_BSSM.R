...
save(DD.lst, DDpriors,DD.out,DD.dat,mod.out,mod.dat,cpue.dat,yrs,
     file=paste0(repo.loc,"/Results/Sab_SS_model/R_75_FR_90/Retros/Sable_SSmodel_results_",strt.mod.yr,"_",i,".RData"))
}
...
repo.loc <- "D:/Framework/SFA_25_26_2024/Model/"
retro.years <- c(2005:2014,2016:2019,2021,2022)
...
for(j in retro.years)
{
  ...
  load(paste0(repo.loc,"Results/Sab_SS_model/R_75_FR_90/Retros/Sable_SSmodel_results_1994_",j,".RData"))
...
save_plot(paste0(repo.loc,"Figures/Sab/R_",R.size,"_FR_",FR.size,"/Retros/SSModel/Sab_Biomass_retro.png"),b.retro,base_width = 10,base_height =7)
...
save_plot(paste0(repo.loc,"Figures/Sab/R_",R.size,"_FR_",FR.size,"/Retros/SSModel/Sab_Rec_retro.png"),r.retro,base_width = 10,base_height =7)
...
save_plot(paste0(repo.loc,"Figures/Sab/R_",R.size,"_FR_",FR.size,"/Retros/SSModel/Sab_mort_retro.png"),m.retro,base_width = 10,base_height =7)
...
saveRDS(mohns.rhos,paste0(repo.loc,"Results/Sab/R_",R.size,"_FR_",FR.size,"/Retros/Sab_mohns_rose_SSModel.Rds"))
saveRDS(bias,paste0(repo.loc,"Results/Sab/R_",R.size,"_FR_",FR.size,"/Retros/Sab_bias_SSModel.Rds"))
saveRDS(retro.base,paste0(repo.loc,"Results/Sab/R_",R.size,"_FR_",FR.size,"/Retros/Sab_retro_SSModel.Rds"))
